...
// Nova rota raiz para facilitar teste via proxy do EasyPanel
app.get("/", (_req,res)=>{
  res.type("html").send(`
  <html>
    <head><meta charset="utf-8"><title>WA ENC Decryptor</title></head>
    <body style="font-family: system-ui, -apple-system, Segoe UI, Roboto; padding: 24px">
      <h1>WA ENC Decryptor</h1>
      <p>Status: <code>OK</code></p>
      <ul>
        <li>Health: <a href="/health">/health</a></li>
        <li>GET decrypt exemplo: <code>/decrypt?url=...&mediaKey=...&mediaType=image&return=base64</code></li>
      </ul>
    </body>
  </html>
  `);
